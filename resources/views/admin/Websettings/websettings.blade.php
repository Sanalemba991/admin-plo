                        ...
                        <div class="tab-pane fade" id="account-vertical-shipping" role="tabpanel"
                            ...
                            <form class="shipping_policy" method="post" action="{{ route('update.gameConfig') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <div class="form-group">
                                            <label>User win% vs Bot</label>
                                            <div class="input-group mb-2">
                                                <input type="number" class="form-control commission"
                                                    value="{{ $websetting->bot_win_per }}" name="bot_win_per" />
                                 ...
                                 <!--   <div class="col-12 col-sm-6">
                                        <div class="form-group">
                                            <label>PlayStore Sequrity</label>
                                            <select class="select2 form-control form-control-lg bot_status"
                                                name="playstore_sequrity">
                                                <option value="">Select</option>
                                                @if ($websetting->playstore_sequrity == 1)
                                                    <option value="1" selected>Active</option>
                                                    <option value="0">Deactive</option>
                                                @else
                                                    <option value="1">Active</option>
                                     ...
                                     <div class="col-12 col-sm-6">
                                        <div class="form-group">
                                            <label>User Win Percentage VS Bot</label>
                                            <input type="text" class="form-control purchase_link"
                                                value="{{ $websetting->bot_win_per }}" required
                                                name="bot_win_per" />-->
                                        </div>
                                    </div>
                                  <!--  <div class="col-12 col-sm-6">
                                        <div class="form-group">
                                            <label>Game Time (secs)</label>
                                            <input type="text" class="form-control purchase_link"
                                                value="{{ $websetting->game_time }}" required
                                                name="game_time" />
                                        </div>
                                    </div>
