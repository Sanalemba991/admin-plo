...
<div class="main-menu menu-fixed {{ $websettings->sideskin_mode }} menu-accordion menu-shadow"
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item"><a class="d-flex align-items-center"
                    href="{{ url('/') }}/admin/player/bot"><i class="las la-users"></i><span
                        class="menu-title text-truncate" data-i18n="Invoice">All Bot</span></a>
            </li>
            <li class="nav-item"><a class="d-flex align-items-center"
                    href="{{ url('/') }}/admin/player/banner"><i class="las la-users"></i><span
                        class="menu-title text-truncate" data-i18n="Invoice">Sliding Banner</span></a>
            </li>
              <li class="nav-item"><a class="d-flex align-items-center"
                    href="{{ url('/') }}/admin/bid/coupons"><i class="las la-users"></i><span
                        class="menu-title text-truncate" data-i18n="Invoice">Coupons</span></a>
            </li>
        ...
        <ul class="menu-content">
            ...
            <li class="nav-item"><a class="d-flex align-items-center" href="{{ url('/') }}/admin/bid/coin"><i
                        class="las la-dice-five"></i><span class="menu-title text-truncate" data-i18n="Invoice"> Create Contest</span></a>
     
            
              <li class="nav-item"><a class="d-flex align-items-center" href="{{ url('/') }}/admin/bid/leagues"><i
                        class="las la-hand-scissors"></i><span class="menu-title text-truncate" data-i18n="Invoice">Manage Tournament</span></a>
            </li>
