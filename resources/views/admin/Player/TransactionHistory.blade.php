                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <div class="badge badge-light-success">Success</div>
                     @elseif($result->status == "Added by Admin")
                    <div class="badge badge-light-success">Added by Admin</div>
                    @elseif($result->status == "Deduct by Admin")
                    <div class="badge badge-light-danger">Deduct by Admin</div>
                    @else
