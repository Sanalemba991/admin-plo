            ...
            <div class="col-xl-12 col-lg-12 d-flex flex-column justify-content-between border-container-lg">
              <div class="user-avatar-section">
                <div class="d-flex justify-content-start">
                    ...
                    <img src="{{$data->photo}}" height="104" width="104" alt="User avatar"
                    />
                  />
                    @else
                    <img src="{{$data->photo}}" height="104" width="104" alt="User avatar"
...
<button data-id="{{$data->playerid}}" data-banned="{{$data->banned}}" class="btn-sm btn-danger mr-1 border-0 rounded-0 block_btn">Un-Ban</button>
                      @endif
                      <button data-id="{{$data->playerid}}" data-banned="{{$data->banned}}"class="btn-sm btn-success mr-1 border-0 rounded-0 addCoinButton">Approve KYC</button>
                      <button data-id="{{$data->playerid}}" data-banned="{{$data->banned}}" class="btn-sm btn-danger mr-1 border-0 rounded-0 block_btn">Reject KYC</button>
                ...
                <div class="d-flex justify-content-start">
                    ...
                    <div class="user-info mb-1">
                      ...
                      <p class="card-text">Register Date - {{$data->registerDate}}</p>
                       <p class="card-text">Last Login IP: - {{$data->ip}}</p>
                         <p class="card-text">Last {{$data->location}}</p>
                      @if($data->kyc_status==0)
                       <p class="card-text">KYC Status - Pending Upload</p>
                        @elseif($data->kyc_status==1)
                       <p class="card-text">KYC Status - Pending for Approval</p>
                        @elseif($data->kyc_status==2)
                       <p class="card-text">KYC Status - Approved</p>
                         @elseif($data->kyc_status==3)
                       <p class="card-text">KYC Status - Rejected</p>
                       @endif
                    </div>
                  </div>
                </div>
        ...
        <div class="card-header align-items-start pb-0">
          <div>
            <h2 class="font-weight-bolder">
              ...
              PAN NO: {{$data->pan_number}} </h2>
          
          </div>
          
              <img src="{{$data->pan_url}}" height="150" width="300">
            <p><br></p>
        </div>
        ...
        <div class="card-header align-items-start pb-0">
          <div>
            <h2 class="font-weight-bolder">
              ...
              <img src="{{$data->aadhaar_url}}" height="150" width="300">
            <p><br></p>
        </div>
