...
Route::get('/update-composer', function () {
    ...
    return 'Composer update triggered successfully';
});
...
Route::group(['middleware' => 'admin_auth'], function () {
    Route::prefix('admin')->group(function () {
        ...
        Route::get('/player/all', [PlayerController::class, 'AllPlayer']);
         Route::get('/player/bot', [PlayerController::class, 'AllBot']);
        ...
        Route::get('/player/banner', [PlayerController::class, 'AllBanner']);
         Route::post('/player/upload/new', [PlayerController::class, 'UploadSlidingBanner'])->name('create.slidingbanner.new');
         Route::post('/player/upload/delete/{id}', [PlayerController::class, 'DeleteSlidingBanner']);
          Route::get('/player/upload/delete/{id}', [PlayerController::class, 'DeleteSlidingBanner']);
         
         Route::post('/player/createsuperbot', [PlayerController::class, 'CreateBot'])->name('create.superbot.new');
        ...
        Route::get('/bid/coin', [BidConteoller::class, 'index']);
          Route::get('/bid/coupons', [BidConteoller::class, 'coupons']);
        Route::get('/bid/cricket', [BidConteoller::class, 'cricket']);
         Route::get('/bid/leagues', [BidConteoller::class, 'leagues']);
           Route::get('/bid/tournament', [BidConteoller::class, 'tournaments']);
          Route::get('/bid/prizepool', [BidConteoller::class, 'prizepool']);
           Route::get('/bid/rank_user', [BidConteoller::class, 'rankuser']);
            Route::get('/bid/tournament_user', [BidConteoller::class, 'tournament_user']);
        Route::post('/bid/coin/create', [BidConteoller::class, 'create'])->name('create.bidvalue.new');
         Route::post('/bid/coin/create_coupons', [BidConteoller::class, 'create_coupons'])->name('create.coupons.new');
        Route::post('/bid/coin/create_cricket', [BidConteoller::class, 'create_cricket'])->name('create.criketvalue.new');
         Route::post('/bid/coin/create_pool', [BidConteoller::class, 'create_pool'])->name('create.pool.new');
          Route::post('/bid/coin/add_bots', [BidConteoller::class, 'add_bots'])->name('create.bot.new');
          Route::post('/bid/coin/create_league', [BidConteoller::class, 'create_league'])->name('create.league.new');
        Route::post('/bid/coupon/delete/{id}', [BidConteoller::class, 'delete_coupon']);
        Route::get('/bid/coupon/delete/{id}', [BidConteoller::class, 'delete_coupon']);
        
         Route::post('/bid/coupon/delete/{id}', [BidConteoller::class, 'delete']);
        Route::post('/bid/coin/delete_league/{id}', [BidConteoller::class, 'delete_league']);
          Route::get('/bid/coin/delete_league/{id}', [BidConteoller::class, 'delete_league']);
        Route::get('/bid/coin/edit/{id}', [BidConteoller::class, 'edit']);
        Route::post('/bid/coin/update/{id}', [BidConteoller::class, 'update']);
        Route::get('/bid/coin/edit_league/{id}', [BidConteoller::class, 'edit_league']);
        Route::post('/bid/coin/update_league/{id}', [BidConteoller::class, 'update_league']);
        ...
        Route::post('/tournament/create/new', [BidConteoller::class, 'Create_tournament'])->name('create.tournament.new');
...
Route::get('/create-order', [App\Http\Controllers\payment\OrderController::class, 'createOrder']);
