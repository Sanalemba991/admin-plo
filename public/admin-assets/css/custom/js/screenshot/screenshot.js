            ...
            swal(
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        ...
                        $.ajax({
                            type: "post",
                            url: "player/upload/delete/" + delete_id,
                            data: {
                            ...
                            error: function (ajax) {
                                if (ajax.status == 500) {
                                    swal({
                                        title: "Opps !",
                                        text: "8Error " + ajax.status + ": " + ajax.statusText,
                                        type: "error",
                                        showCancelButton: true,
                                ...
                                if (ajax.status == 404) {
                                    swal({
                                        title: "Opps !",
                                        text: "7Error " + ajax.status + ": " + ajax.statusText,
                                        type: "error",
                                        showCancelButton: true,
                                        confirmButtonText: "Ok",
                                    });
                        ...
                        $.ajax({
                            ...
                            error: function (ajax) {
                                if (ajax.status == 500) {
                                    swal({
                                        title: "Opps !",
                                        text: "4Error " + ajax.status + ": " + ajax.statusText,
                                        type: "error",
                                        showCancelButton: true,
                                        confirmButtonText: "Ok",
                                    });
                                ...
                                if (ajax.status == 404) {
                                    swal({
                                        title: "Opps !",
                                        text: "3Error " + ajax.status + ": " + ajax.statusText,
                                        type: "error",
                                        showCancelButton: true,
                                        confirmButtonText: "Ok",
                                    });
        ...
        $.ajax({
            ...
            error: function (ajax) {
                if (ajax.status == 500) {
                    swal({
                        title: "Opps !",
                        text: "2Error " + ajax.status + ": " + ajax.statusText,
                        type: "error",
                        showCancelButton: true,
                        confirmButtonText: "Ok",
                    });
                ...
                if (ajax.status == 404) {
                    swal({
                        title: "Opps !",
                        text: "1Error " + ajax.status + ": " + ajax.statusText,
                        type: "error",
                        showCancelButton: true,
                        confirmButtonText: "Ok",
                    });
